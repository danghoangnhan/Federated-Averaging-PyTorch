...
def main():
    ...
    #print(avg_KL)
    Save_KL_Result("SingleMachine_MNIST(MLP)", KL_of_each_client, avg_KL)
    ...
    Save_Accuracy_of_each_epoch(0, "SingleMachine_MNIST(MLP)", accuracy_of_each_epoch,best_accuracy_of_each_epoch)    
    #print(accuracy_of_each_epoch)
    CreateResultData("SingleMachine_MNIST(MLP)", "MNIST", "MLP", "", "", args.epochs, accuracy, "")
    if args.save_model:
