...
def build_data_provider(local_batch_size, examples_per_user, drop_last: bool = False):
    ...
    index_of_head_group, time = ILP_method(train_dataset, num_of_CIFAR10_label, dict_users, client_num, num_of_head_client, Max_value_of_ILP)
...
def run(cfg: DictConfig) -> None:
    print('-------------------FL_non_IID_ILP_cifar10(CNN)-------------------')
    #print(cfg)
