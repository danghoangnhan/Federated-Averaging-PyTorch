...
import random
import sys
sys.path.append("c:\\Users\\mobile_lab\\Desktop\\408261204\\Federated-Averaging-PyTorch-main\\src\\Determined")
from Determined_KLD import FKLD,FKLD_noself
from Determined_network import Generate_network
from Determined_Client import Generate_Client

def D_Cij(Client_number,Client_node_number,CD,MD_label,MD_label_len,node_size,W1,W2,shortest_path_length,comp):
    ...
    """
    if(not isself):
        KL= FKLD_noself(Client_number,Client_number,CD,MD_label,MD_label_len,comp)
        
    else:
        KL= FKLD(Client_number,Client_number,CD,MD_label,MD_label_len,comp)
    """
    KL= FKLD_noself(Client_number,Client_number,CD,MD_label,MD_label_len,comp)
    ###算Mcij
    W1 = 0.5
    ...
    return (normal_KL * W1)+(normal_tran * W2)
    """
    print("shortest_path: ",shortest_path)
    print("shortest_path_length: ",shortest_path_length)
    ax = plt.gca()
