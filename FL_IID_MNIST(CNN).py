...
def main(
    ...
    CreateResultData("FL_IID_MNIST(CNN)", "MNIST", "CNN", "IID", client_num, int(trainer_config.epochs),
                     eval_score['Accuracy'], "")
...
if __name__ == "__main__":
    json_cfg = fl_config_from_json(json.load(open('configs/MNIST_config.json')))
