...
class MetricsReporter(FLMetricsReporter):
    ...
    def compare_metrics(self, eval_metrics, best_metrics):
        #self.test_value.append(eval_metrics)
        ...
        #the best accuracy of the epoch 2 is the accuracy of the epoch 1
        if self.round==0:
            self.AccuracyList.append(best_accuracy) 
        self.AccuracyList.append(current_accuracy) 
