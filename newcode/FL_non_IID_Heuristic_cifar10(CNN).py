...
def build_data_provider(local_batch_size, examples_per_user, drop_last: bool = False):
    ...
    index_of_head_group, time = heuristic_method(train_dataset, num_of_CIFAR10_label, dict_users, client_num, num_of_head_client)
...
def main(
    ...
    Save_Accuracy_of_each_epoch(1, "FL_non_IID_Heuristic_cifar10(CNN)", accuracy_of_each_epoch,best_accuracy_of_each_epoch)
    client_num=num_of_original_client
    global total_execution_time
