...
def main():
    ...
    heuristic_index_of_head_group, time = heuristic_method(train_dataset, num_of_CIFAR10_label, dict_users, client_num, num_of_used_client, num_of_head_client)
    ...
    ##########ILP method##########
    print("##########ILP method##########")
    ILP_index_of_head_group, ILP_time = ILP_method(train_dataset, num_of_CIFAR10_label, dict_users, client_num, num_of_used_client, num_of_head_client, Max_value_of_ILP)
    ...
    ILP_KL_of_each_client, ILP_avg_KL = get_KL_value(sorted_ILP_method_train_dataset, num_of_CIFAR10_label, num_of_client)
    #print(ILP_avg_KL)
